            ...
            <div className="min-h-screen">
                ...
                <div className="min-h-screen">
                    <div className="flex justify-end py-6">
                        <h1>LISTING: <span className="font-bold">29 ROOMS LEFT</span></h1>
                    </div>
                    <div className="grid grid-cols-4 gap-4">
                         ...
                         <div>
                            ...
                            />
                            <div className="mt-4">
                                <div className="text-xs font-bold text-sky-500">{mockListings.title}</div>
                                <div className="mt-1 font-bold text-gray-700">
                                <a href="" className="hover:underline">{mockListings.title}</a>
                                </div>
                                <div className="mt-2 text-sm text-gray-600">{mockListings.price}</div>
                                </div>
                            </div>
