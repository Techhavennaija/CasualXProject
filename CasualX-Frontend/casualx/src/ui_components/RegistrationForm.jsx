...
function RegistrationForm() {
  ...
  // Validate step 2
    ...
    const newErrors = {};
        ...
        if (!formData.languageSpoken) newErrors.languageSpoken = 'Language Spoken is required.';
        if (!formData.languageLevel) newErrors.languageLevel = 'Language Level is required.';
  ...
  const validateStep4 = () => {
    ...
    if (!formData.oneHourRate1) newErrors.oneHourRate1 = '1 Hour Rate is required.';
    if (!formData.overnightRate1) newErrors.overnightRate1 = 'Overnight Rate is required.';
    if (!formData.weekendRate1) newErrors.weekendRate1 = 'Weekend Rate is required.';
  ...
  const submitForm = async () => {
    ...
    const renderStep = () => {
        switch (step) {
            case 1:
                return <Step1 formData={formData} handleChange={handleChange} nextStep={nextStep} errors={errors} 
